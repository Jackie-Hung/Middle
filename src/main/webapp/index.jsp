    ...
    <div class="container">
      <div class="row">
        ...
        <div class="links span8">
            <% if(session.getAttribute("username")==null){%>
          <a class="login" href="login.jsp" rel="tooltip" data-placement="bottom"
           data-toggle="modal" data-target="#myModal1"></a>
          <a class="register" href="logup.jsp" rel="tooltip" data-placement="bottom"
             data-toggle="modal" data-target="#myModal2"></a>
            <%}else{%>
            <a class="logout" href="logout.jsp" rel="tooltip" data-placement="bottom"
